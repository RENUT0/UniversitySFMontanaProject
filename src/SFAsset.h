 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_BACKGROUND, SFASSET_PROJECTILE, SFASSET_ALIEN, SFASSET_COIN, SFASSET_BARRIER, SFASSET_BARRIER2};
...
public:
  ...
  virtual void      GoSlow();
  virtual void      SlowEast();
  virtual void      SlowWest();
  virtual void      PlzStop();
